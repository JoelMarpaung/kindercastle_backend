...
func (s service) GetMyBook(ctx context.Context, param payload.PagingAndFilterPayload, userID string) ([]payload.Book, int64, error) {
	...
	books, count, err := s.Book.GetMyBook(ctx, param, userID)
	if err != nil {
